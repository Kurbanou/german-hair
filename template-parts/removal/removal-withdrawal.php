...
/**
 * Displays removal withdrawal
 */
$card_list = [
  [
    'title' => 'Диагностика',
    'text' => 'Оценка состояния волос и типа крепления',
  ],
  [
    'title' => 'Обработка',
    'text' => 'Нанесение специального состава для размягчения капсул',
  ],
  [
    'title' => 'Аккуратное удаление',
    'text' => 'Каждая прядь снимается отдельно',
  ],
  [
    'title' => 'Очищение',
    'text' => 'Удаление остатков кератина',
  ],
];

?>
<section class="removal withdrawal">
  ...
  <div class="container">
    <div class="removal-withdrawal__content">
      <h2 class="h2 text-second-dark">Как проходит профессиональное снятие волос</h2>
      <div class="withdrawal__container">
        <?php foreach ($card_list as $key => $card): ?>
          <div class="color-card">
            <div class="removal-withdrawal__content_number"><?php echo '0'.$key+1; ?></div>
            <div class="removal-withdrawal__content_title"><?php echo $card['title']; ?></div>
            <div class="removal-withdrawal__content_text"><?php echo $card['text']; ?></div>
          </div>
        <?php endforeach; ?>
      </div>
