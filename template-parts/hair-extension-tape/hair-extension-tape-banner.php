  ...
  <?php else: ?>
    ...
    <div class="container">
      <div class="tape-banner__content">
        ...
        <p class="banner-p">Хотите густые и длинные волосы без вреда для своих? <br />Ленточное наращивание – это быстрый и безопасный способ добавить объем и длину.</p>
        <p class="banner-p">Всего за 30 минут вы получите идеальный результат с эффектом натуральных волос.</p>
        <div class="cat">
