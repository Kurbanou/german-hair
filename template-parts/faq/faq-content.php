    ...
    <div class="container">
        ...
        <div class="flex flex-gap-l mb-s">
            <ul class="list-disk  weight-500">
                ...
                <li>Как часто нужно делать коррекцию после процедуры</li>
            </ul>
            <ul class="list-disk   weight-500">
                <li>Из чего складывается и как формируется стоимость процедуры</li>
                <li>И многое другое - буквально, всё, что вы хотите спросить!</li>
            </ul>
        </div>
        <p class="weight-500 "> Если вы не нашли нужный ответ — не переживайте. Вы всегда можете задать свой вопрос в форме ниже, и мы с радостью ответим вам. </p>
    </div>
