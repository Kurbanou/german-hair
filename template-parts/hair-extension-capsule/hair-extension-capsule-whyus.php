...
/**
 * Displays hair-extension-capsule-whyus
 */
$url = get_field('pochemu_klienty_vybirayut_nas');

?>
<section class="capsule whyus">
    ...
    <div class="content">
      ...
      <div class="content-text">
        <div class="section-header">
          <h2 class="h2 text-second-dark">Почему клиенты выбирают нас</h2>
        </div>

        <ul class="ul-disk">
          <li>10 лет успешной работы</li>
          <li>Только профессиональные мастера с сертификатами</li>
          <li>Используем лучшие материалы </li>
