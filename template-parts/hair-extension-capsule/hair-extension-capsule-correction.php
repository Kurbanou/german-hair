 ...
 */
$url = get_field('korrekcziya_volos');
    ...
    <div class="content">
      ...
      <div class="content-text">
        <div class="section-header">
          <h2 class="h2 text-second-dark">Коррекция волос</h2>
        </div>
        <p>Коррекцию обычно делают каждые 2 месяца. <br />Если волосы густые и плотные — можно носить до 3 месяцев. <br />Если тонкие и редкие — лучше делать коррекцию не реже, чем раз в 2 месяца. </p>
        <p>Она включает в себя несколько этапов:</p>
        <ul class="ul-disk">
          <li>Снятие капсул </li>
          <li>Обновление кератиновых капсул (капсуляция)</li>
          <li>Мытьё головы </li>
          <li>Наращивание новых капсул согласно оговоренной схеме расстановки</li>
        </ul>
