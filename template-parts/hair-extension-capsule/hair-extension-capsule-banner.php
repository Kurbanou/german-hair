  ...
  <?php else: ?>
    ...
    <div class="container">
      <div class="capsule-banner__content">
        ...
        <p class="banner-p">Мечтаете о длинных, густых волосах, которые выглядят на 100% естественно?</p>
        <p class="banner-p">Капсульное наращивание в нашем салоне — это современное решение для мгновенного преображения. Всего за 2-3 часа вы получите идеальные волосы желаемой длины и объема, которые невозможно отличить от натуральных.</p>
        <div class="discounts">
