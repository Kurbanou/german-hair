...
/**
 * Подшаблон: Форма для заявок
 */
?>
<section class="comment-form obuchenie zayvka">
  <div class="container">
  ...
  <div class="section-bg-mobile rtl">
    <svg width="480" height="39" viewBox="0 0 480 39" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M480 37.6042C480 37.6042 390.045 12.7262 329.733 9.30464C283.156 6.66227 256.279 8.06199 210.312 14.3238C173.219 19.3769 147.15 21.5197 108.497 21.5197C73.0095 21.5197 25.7257 8.75057 9.98378e-06 1.146" stroke="#967866" stroke-opacity="0.2" />
      <rect x="385" y="21.7456" width="16" height="16" rx="8" transform="rotate(180 385 21.7456)" fill="#EAE4E0" />
    </svg>
